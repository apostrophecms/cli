...
util.getStrings = (version, command, moduleName) => {
  const allStrings = require('./boilerplate')(moduleName);
...
async function checkIfUpdated () {
  try {
    ...
    // TODO: Update to print error once published.
    console.info('🥸 @apostrophecms/cli has not been published yet.');
  }
}
